# soil_mlops_gui.py
#
# Responsive Windows GUI for SOIL MLOPS
#
# Main features
# -------------
# 1. Final regression/classification report launcher.
# 2. Regression/classification report-folder browsing.
# 3. Default or user-selected CSV dataset.
# 4. Responsive feature-set manager based on params.yaml:
#
#       TARGETS:
#         AC:
#           fs1:
...
#             - PI
#
# 5. View, edit, add, rename, duplicate, and delete feature sets.
# 6. Define one or many feature sets before saving.
# 7. Preserve all unrelated sections of params.yaml.
# 8. Automatically create a timestamped backup before params.yaml is changed.
# 9. YAML preview before saving.
# 10. Responsive PanedWindow layout that fits common laptop screens,
#     including 1366x768 displays and Windows display scaling.
#
# Required packages:
